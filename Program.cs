...
Console.WriteLine("Hello, Eduardo Solano");
...
string[] names2 = new[] { "Erick", "John", "Jennifer", "Tommy" };
...
{
  new[] { "Ford", "Toyota", "Honda" },
  new[] { "Mercedes", "Audi", "BMW", "Porsche" },
  new[] { "Kia", "Tesla" }
};
